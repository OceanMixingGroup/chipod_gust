...
%     Tue Aug 30 14:32:26 PDT 2016
    ...
    % master.use_pres = 0; % Use accelerometer information by default
   ...
   methods 
      ...
      %  inconsitent flags
         ...
         if obj.master.vc     == 0; obj = obj.c_vc(0); end
      ...
      function [] = readme(obj) 
         disp({'______ THE DIFFERENT FLAGS HAVE THE FOLLOWING MEANING_______';
              ''      ;
               ...
               'use_pres : differentiate pressure to get speed past sensor';
               '';
               '% normal processing';
                '% for pitot eps';
