function [chi_wda] = do_wda_estimate(pflag, data, chi, T, Tp)

    % ENHANCE! T and Tp to get higher resolution time series
    % Mudge & Lueck (1994)
    % cross-over frequency at 1Hz
    ...
    % wda50 = do_wda_estimate(pflag.master.wda_dt, acc50hz, chi, T50hz, Tp);
