function [chi,k,spec,k_kraich,spec_kraich,stats]=...
    eps_fit_chi(freq,tp_power,fspd,nu,tdif,eps)
%
% [chi,k,spec,k_kraich,spec_kraich,stats]=...
%    eps_fit_chi(freq,tp_power,fspd,nu,tdif,eps)
%
% to compute chi from Tp for a given epsilon.  
%
